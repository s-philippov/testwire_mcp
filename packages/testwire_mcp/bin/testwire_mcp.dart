...
import 'package:testwire_mcp/src/compat/copilot_stdio_server_transport.dart';
import 'package:testwire_mcp/src/tool_definitions.dart';
import 'package:testwire_mcp/src/vm_service_context.dart';
...
void printUsage(ArgParser argParser) {
  stderr
    ..writeln(
      'Testwire MCP Server - AI agent control for Flutter integration tests',
    )
    ..writeln()
    ..writeln('Usage: testwire_mcp [options]')
    ..writeln()
    ..writeln('Options:')
...
Future<int> main(List<String> arguments) async {
  ...
  try {
    ...
    if (results.flag('version')) {
      stderr.writeln('testwire_mcp version: $_version');
      return 0;
    }
